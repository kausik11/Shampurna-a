...
import { FiArrowLeft, FiLoader, FiRefreshCcw, FiSend } from 'react-icons/fi'
    ...
    <section className="relative overflow-hidden px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[0.78fr_1.22fr] lg:items-stretch">
          ...
          <div className="flex min-h-[34rem] flex-col rounded-[1.25rem] border border-white/12 bg-[rgba(1,0,2,0.54)] shadow-[0_28px_90px_rgba(1,0,2,0.36)] backdrop-blur-2xl sm:rounded-[1.5rem]">
            <div className="flex items-center justify-between gap-3 border-b border-white/10 px-4 py-4 sm:px-5">
              <div>
                <p className="text-sm font-semibold text-[var(--color-heading)]">Shampurna Assistant</p>
            ...
            <form className="border-t border-white/10 p-3 sm:p-4" onSubmit={submitMessage}>
              <label className="sr-only" htmlFor="clinic-chat-message">
                Type your message
              </label>
              <div className="flex flex-col gap-3 rounded-[1rem] border border-white/12 bg-white/[0.05] p-2 sm:flex-row sm:items-end">
                <textarea
                  id="clinic-chat-message"
                  className="min-h-24 flex-1 resize-none bg-transparent px-3 py-3 text-sm leading-6 text-[var(--color-heading)] outline-none placeholder:text-white/38 sm:min-h-12"
