      ...
      <div className="mt-10 grid gap-5 sm:mt-12 md:grid-cols-2 xl:grid-cols-3">
        {whyChooseUs.map((item) => {
          ...
          return (
            <GlassPanel
              key={item.title}
              className="reveal group relative overflow-hidden p-5 transition duration-500 hover:-translate-y-2 hover:border-[rgba(252,223,92,0.2)] sm:p-6"
            >
              ...
              <div className="relative">
                ...
                <h3 className="mt-5 text-wrap font-display text-2xl leading-tight text-[var(--color-heading)] lg:text-3xl">
                  {item.title}
                </h3>
