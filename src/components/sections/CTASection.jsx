  ...
  return (
    <section ref={sectionRef} className="relative px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
      <div className="mx-auto max-w-7xl">
        <div className="reveal relative overflow-hidden rounded-[1.25rem] border border-[rgba(235,200,0,0.18)] bg-[linear-gradient(135deg,rgba(1,0,2,0.62),rgba(56,8,40,0.86),rgba(245,73,145,0.12))] px-4 py-9 shadow-[0_30px_80px_rgba(1,0,2,0.36)] backdrop-blur-2xl sm:rounded-[2.25rem] sm:px-10 sm:py-12 lg:flex lg:items-center lg:justify-between lg:gap-10 lg:px-14">
          ...
          <div className="relative max-w-2xl">
            <p className="text-[10px] font-semibold uppercase tracking-[0.16em] text-[var(--color-gold)] sm:text-xs sm:tracking-[0.3em]">
              Final Invitation
            </p>
            <h2 className="mt-4 text-wrap font-display text-[2rem] leading-tight text-[var(--color-heading)] min-[390px]:text-4xl sm:text-5xl sm:leading-none">
